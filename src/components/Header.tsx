...
import { Sun, Moon, Shuffle, Network, LogOut, LogIn, User } from 'lucide-react';
...
function HeaderContent({ onRandomAnnotation, onNavigateGraph, onNavigateHome, onNavigateAuth }: HeaderProps) {
